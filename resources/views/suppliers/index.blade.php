        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Kelola data vendor dan pemasok barang gudang.
                </p>
            </div>

            {{-- TOMBOL TAMBAH SUPPLIER (KHUSUS ADMIN) --}}
            ...
            <form action="{{ route('suppliers.index') }}" method="GET" class="flex gap-2">
                <div class="relative w-full">
                    ...
                    <input type="text"
                           ...
                           placeholder="Cari berdasarkan nama supplier, email, telepon, atau alamat..."
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
                            ...
                            @foreach ($suppliers as $index => $supplier)
                                <tr class="bg-white hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 font-medium text-gray-900 dark:text-white">
                                        {{ method_exists($suppliers, 'firstItem') ? $suppliers->firstItem() + $index : $index + 1 }}
                                    </td>
            ...
            @else
                <div class="p-6 text-center text-gray-500 dark:text-gray-400">
                    Tidak ada data supplier yang sesuai dengan kriteria pencarian.
                </div>
            @endif
