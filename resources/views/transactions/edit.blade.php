    ...
    <div class="p-6">
        ...
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Perbarui data transaksi atau ubah status transaksi.
            </p>
        </div>
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea
                            ...
                            name="notes"
                            rows="3"
                            class="block w-full p-2.5 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('notes', $transaction->notes) }}</textarea>
                    </div>
