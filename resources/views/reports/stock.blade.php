...
<div class="p-6">
    ...
    <div class="p-4 mb-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 print:hidden">
        <form method="GET" action="{{ route('reports.stock') }}" class="flex flex-col gap-4 sm:flex-row sm:items-end">
            <div class="flex-1">
            ...
            <div class="flex gap-2">
                ...
                @if($selectedCategory)
                    <a 
                        ...
                        class="px-5 py-2.5 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600"
                    >
                        Reset
                    </a>
                @endif
